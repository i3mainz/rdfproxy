...
public class SPARQL extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			if (format.equals("html")) {
				...
				SPARQLqueryOutputFile(repo, query, format, outstream);
			}
	...
	public static ServletOutputStream SPARQLqueryOutputFile(String repositoryID, String queryString, String format, ServletOutputStream out) {
		try {
			String SesameSever = "http://labeling.i3mainz.hs-mainz.de/openrdf-sesame";
